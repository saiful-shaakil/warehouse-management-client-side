...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-white-800 pt-4 pb-8 xl:pt-8">
      <div className="max-w-screen-lg xl:max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 text-gray-800 dark:text-gray-800">
        <ul className="text-lg font-light pb-8 flex flex-wrap justify-center">
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <ul>
                <li className="mb-4 hover:text-gray-800 dark:hover:text-red-400 transition-colors duration-200">
        ...
        <div className="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
          <Link to="/">
            <svg
              ...
              height="20"
              fill="currentColor"
              className="text-xl hover:text-gray-800 dark:hover:text-red-400 transition-colors duration-200"
